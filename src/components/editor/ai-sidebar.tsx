...
const EDIT_TOOL_LABELS: Record<string, string> = {
  "tool-insert_text": "Menyisipkan teks",
  "tool-replace_text": "Mengganti teks",
  "tool-format_text": "Mengubah format",
};
            ...
            <div key={message.id} className="space-y-1.5">
              {message.parts.map((part, i) => {
                ...
                if (
                  ...
                  const label = EDIT_TOOL_LABELS[part.type];
                  ...
                  if (part.state === "output-error") {
                    return (
                      <div
                        key={i}
                        className="rounded-md border border-destructive/50 px-2.5 py-1.5 text-xs text-destructive"
                      >
                        {part.errorText}
                      </div>
                    );
